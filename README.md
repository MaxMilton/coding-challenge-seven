...
| [4. Vue](http://MaxMilton.github.io/coding-challenge-seven/4-vue/) | [Vue.js](https://vuejs.org/) | Webpack | 72 KB | 23 KB | Simple implementation using Vue, another popular framework which is fast both in the sence of performance but also in regards to development speed. The Vue community is as rich as React's and this also makes it a great choice for enterprise projects. |
